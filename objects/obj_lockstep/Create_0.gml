...
frame_skip = 1; //2; // finds ratio of game frames to room speed.  frame_skip+1/room_speed is the real rate
...
input_delay = 1; //2; // number of frames input delay. (input_delay+1)*(frame_skip+1)/room_speed is the real delay time
